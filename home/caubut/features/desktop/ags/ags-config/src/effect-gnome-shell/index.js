...
import Utils, { timeout, readFileAsync , loadInterfaceXML } from './utils.js';
...
export interface Config {
    windows?: Array<Gtk.Window> | (() => Array<Gtk.Window>)
    style?: string
    icons?: string
    gtkTheme?: string
    iconTheme?: string
...
export class App extends Gtk.Application {
    ...
    private _cssProviders: Array<Gtk.CssProvider> = [];
    ...
    readonly connect = (signal = 'window-toggled', callback: (_: this, ...args: Array<any>) => void) => {
