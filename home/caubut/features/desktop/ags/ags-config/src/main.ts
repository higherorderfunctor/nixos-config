...
import { GjsContext, GjsRuntime } from "./platform-gjs/index.js"
import { defaultConsole } from "./platform-gjs/internal/defaultServices/console.js"
...
Effect.suspend(() => cli([System.programInvocationName, ...ARGV])).pipe(
  Effect.provide(GjsContext.layer),
  Console.withConsole(defaultConsole),
  GjsRuntime.runMain
)
//
