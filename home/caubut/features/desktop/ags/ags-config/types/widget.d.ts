...
export declare const Window: <Child extends Gtk.Widget, Attr>(props?: WindowProps<Child, Attr> | undefined) => WindowClass<Child, Attr>;
export declare const Box: <Child extends Gtk.Widget, Attr>(props?: BoxProps<Child, Attr> | undefined) => BoxClass<Child, Attr>;
export declare const Button: <Child extends Gtk.Widget, Attr>(props?: ButtonProps<Child, Attr> | undefined) => ButtonClass<Child, Attr>;
export declare const CenterBox: <StartWidget extends Gtk.Widget, CenterWidget extends Gtk.Widget, EndWidget extends Gtk.Widget, Attr>(props?: CenterBoxProps<StartWidget, CenterWidget, EndWidget, Attr> | undefined) => CenterBoxClass<StartWidget, CenterWidget, EndWidget, Attr>;
export declare const CircularProgress: <Child extends Gtk.Widget, Attr>(props?: CircularProgressProps<Child, Attr> | undefined) => CircularProgressClass<Child, Attr>;
export declare const Entry: <Attr>(props?: EntryProps<Attr> | undefined) => EntryClass<Attr>;
export declare const EventBox: <Child extends Gtk.Widget, Attr>(props?: EventBoxProps<Child, Attr> | undefined) => EventBoxClass<Child, Attr>;
...
export declare const Menu: <Child extends Gtk.MenuItem, Attr>(props?: MenuProps<Child, Attr> | undefined) => MenuClass<Child, Attr>;
export declare const MenuItem: <Child extends Gtk.Widget, Attr>(props?: MenuItemProps<Child, Attr> | undefined) => MenuItemClass<Child, Attr>;
export declare const Overlay: <Child extends Gtk.Widget, Attr>(props?: OverlayProps<Child, Attr> | undefined) => OverlayClass<Child, Attr>;
export declare const ProgressBar: <Attr>(props?: ProgressBarProps<Attr> | undefined) => ProgressBarClass<Attr>;
export declare const Revealer: <Child extends Gtk.Widget, Attr>(props?: RevealerProps<Child, Attr> | undefined) => RevealerClass<Child, Attr>;
export declare const Scrollable: <Child extends Gtk.Widget, Attr>(props?: ScrollableProps<Child, Attr> | undefined) => ScrollableClass<Child, Attr>;
export declare const Slider: <Attr>(props?: SliderProps<Attr> | undefined) => SliderClass<Attr>;
export declare const Stack: <Child extends Gtk.Widget, Attr>(props?: StackProps<Child, Attr> | undefined) => StackClass<Child, Attr>;
export declare const Calendar: <Attr>(props?: Etc.CalendarProps<Attr> | undefined) => Etc.Calendar<Attr>;
export declare const ColorButton: <Attr>(props?: Etc.ColorButtonProps<Attr> | undefined) => Etc.ColorButton<Attr>;
export declare const DrawingArea: <Attr>(props?: Etc.DrawingAreaProps<Attr> | undefined) => Etc.DrawingArea<Attr>;
export declare const FileChooserButton: <Attr>(props?: Etc.FileChooserButtonProps<Attr> | undefined) => Etc.FileChooserButton<Attr>;
export declare const Fixed: <Attr>(props?: Etc.FixedProps<Attr> | undefined) => Etc.Fixed<Attr>;
export declare const FlowBox: <Attr>(props?: Etc.FlowBoxProps<Attr> | undefined) => Etc.FlowBox<Attr>;
export declare const FontButton: <Attr>(props?: Etc.FontButtonProps<Attr> | undefined) => Etc.FontButton<Attr>;
export declare const LevelBar: <Attr>(props?: Etc.LevelBarProps<Attr> | undefined) => Etc.LevelBar<Attr>;
export declare const ListBox: <Attr>(props?: Etc.ListBoxProps<Attr> | undefined) => Etc.ListBox<Attr>;
export declare const MenuBar: <Attr>(props?: Etc.MenuBarProps<Attr> | undefined) => Etc.MenuBar<Attr>;
export declare const Separator: <Attr>(props?: Etc.SeparatorProps<Attr> | undefined) => Etc.Separator<Attr>;
export declare const SpinButton: <Attr>(props?: Etc.SpinButtonProps<Attr> | undefined) => Etc.SpinButton<Attr>;
export declare const Spinner: <Attr>(props?: Etc.SpinnerProps<Attr> | undefined) => Etc.Spinner<Attr>;
export declare const Switch: <Attr>(props?: Etc.SwitchProps<Attr> | undefined) => Etc.Switch<Attr>;
export declare const ToggleButton: <Attr>(props?: Etc.ToggleButtonProps<Attr> | undefined) => Etc.ToggleButton<Attr>;
...
declare namespace W {
    ...
    var Box: <Child extends Gtk.Widget, Attr>(props?: BoxProps<Child, Attr> | undefined) => BoxClass<Child, Attr>;
    var Button: <Child extends Gtk.Widget, Attr>(props?: ButtonProps<Child, Attr> | undefined) => ButtonClass<Child, Attr>;
    var CenterBox: <StartWidget extends Gtk.Widget, CenterWidget extends Gtk.Widget, EndWidget extends Gtk.Widget, Attr>(props?: CenterBoxProps<StartWidget, CenterWidget, EndWidget, Attr> | undefined) => CenterBoxClass<StartWidget, CenterWidget, EndWidget, Attr>;
    var CircularProgress: <Child extends Gtk.Widget, Attr>(props?: CircularProgressProps<Child, Attr> | undefined) => CircularProgressClass<Child, Attr>;
    var Entry: <Attr>(props?: EntryProps<Attr> | undefined) => EntryClass<Attr>;
    var EventBox: <Child extends Gtk.Widget, Attr>(props?: EventBoxProps<Child, Attr> | undefined) => EventBoxClass<Child, Attr>;
    var Icon: <Attr>(props?: IconProps<Attr>) => IconClass<Attr>;
    var Label: <Attr>(props?: LabelProps<Attr>) => LabelClass<Attr>;
    var Menu: <Child extends Gtk.MenuItem, Attr>(props?: MenuProps<Child, Attr> | undefined) => MenuClass<Child, Attr>;
    var MenuItem: <Child extends Gtk.Widget, Attr>(props?: MenuItemProps<Child, Attr> | undefined) => MenuItemClass<Child, Attr>;
    var Overlay: <Child extends Gtk.Widget, Attr>(props?: OverlayProps<Child, Attr> | undefined) => OverlayClass<Child, Attr>;
    var ProgressBar: <Attr>(props?: ProgressBarProps<Attr> | undefined) => ProgressBarClass<Attr>;
    var Revealer: <Child extends Gtk.Widget, Attr>(props?: RevealerProps<Child, Attr> | undefined) => RevealerClass<Child, Attr>;
    var Scrollable: <Child extends Gtk.Widget, Attr>(props?: ScrollableProps<Child, Attr> | undefined) => ScrollableClass<Child, Attr>;
    var Slider: <Attr>(props?: SliderProps<Attr> | undefined) => SliderClass<Attr>;
    var Stack: <Child extends Gtk.Widget, Attr>(props?: StackProps<Child, Attr> | undefined) => StackClass<Child, Attr>;
    var Window: <Child extends Gtk.Widget, Attr>(props?: WindowProps<Child, Attr> | undefined) => WindowClass<Child, Attr>;
    var Calendar: <Attr>(props?: Etc.CalendarProps<Attr> | undefined) => Etc.Calendar<Attr>;
    var ColorButton: <Attr>(props?: Etc.ColorButtonProps<Attr> | undefined) => Etc.ColorButton<Attr>;
    var DrawingArea: <Attr>(props?: Etc.DrawingAreaProps<Attr> | undefined) => Etc.DrawingArea<Attr>;
    var FileChooserButton: <Attr>(props?: Etc.FileChooserButtonProps<Attr> | undefined) => Etc.FileChooserButton<Attr>;
    var Fixed: <Attr>(props?: Etc.FixedProps<Attr> | undefined) => Etc.Fixed<Attr>;
    var FlowBox: <Attr>(props?: Etc.FlowBoxProps<Attr> | undefined) => Etc.FlowBox<Attr>;
    var FontButton: <Attr>(props?: Etc.FontButtonProps<Attr> | undefined) => Etc.FontButton<Attr>;
    var LevelBar: <Attr>(props?: Etc.LevelBarProps<Attr> | undefined) => Etc.LevelBar<Attr>;
    var ListBox: <Attr>(props?: Etc.ListBoxProps<Attr> | undefined) => Etc.ListBox<Attr>;
    var MenuBar: <Attr>(props?: Etc.MenuBarProps<Attr> | undefined) => Etc.MenuBar<Attr>;
    var Separator: <Attr>(props?: Etc.SeparatorProps<Attr> | undefined) => Etc.Separator<Attr>;
    var SpinButton: <Attr>(props?: Etc.SpinButtonProps<Attr> | undefined) => Etc.SpinButton<Attr>;
    var Spinner: <Attr>(props?: Etc.SpinnerProps<Attr> | undefined) => Etc.Spinner<Attr>;
    var Switch: <Attr>(props?: Etc.SwitchProps<Attr> | undefined) => Etc.Switch<Attr>;
    var ToggleButton: <Attr>(props?: Etc.ToggleButtonProps<Attr> | undefined) => Etc.ToggleButton<Attr>;
}
export default W;
export declare const Widget: typeof W;
export declare const register: typeof registerClass;
export declare const subclass: typeof W;
