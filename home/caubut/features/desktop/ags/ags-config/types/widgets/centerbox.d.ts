...
export type CenterBoxProps<StartWidget extends Gtk.Widget, CenterWidget extends Gtk.Widget, EndWidget extends Gtk.Widget, Attr = unknown, Self = CenterBox<StartWidget, CenterWidget, EndWidget, Attr>> = BaseProps<Self, Gtk.Box.ConstructorProperties & {
    vertical?: boolean;
