...
export type MenuProps<MenuItem extends Gtk.MenuItem, Attr = unknown, Self = Menu<MenuItem, Attr>> = BaseProps<Self, Gtk.Menu.ConstructorProperties & {
    children?: MenuItem[];
...
export type MenuItemProps<Child extends Gtk.Widget, Attr = unknown, Self = MenuItem<Child, Attr>> = BaseProps<Self, Gtk.MenuItem.ConstructorProperties & {
    child?: Child;
