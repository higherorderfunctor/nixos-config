...
export type WindowProps<Child extends Gtk.Widget, Attr = unknown> = BaseProps<Window<Child, Attr>, Gtk.Window.ConstructorProperties & {
    child?: Child;
    anchor?: Anchor[];
...
export declare class Window<Child extends Gtk.Widget, Attr> extends Gtk.Window {
    constructor({ anchor, exclusive, exclusivity, focusable, keymode, layer, margins, monitor, gdkmonitor, popup, visible, ...params }?: WindowProps<Child, Attr>);
    get child(): Child;
